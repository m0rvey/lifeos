...
describe('StatCard', () => {
  ...
  it('renders subtitle when provided', () => {
    render(<StatCard label="Test Label" value="100" subtitle="Subtitle" />);
  ...
  it('applies accent class when accent is true', () => {
    const { container } = render(<StatCard label="Test Label" value="100" accent />);
  ...
  it('does not apply accent class when accent is false', () => {
    const { container } = render(<StatCard label="Test Label" value="100" accent={false} />);
  ...
  it('renders trend indicator when trend is up', () => {
    const { container } = render(<StatCard label="Test Label" value="100" trend="up" />);
  ...
  it('renders trend indicator when trend is down', () => {
    const { container } = render(<StatCard label="Test Label" value="100" trend="down" />);
  ...
  it('renders trend indicator when trend is neutral', () => {
    const { container } = render(<StatCard label="Test Label" value="100" trend="neutral" />);
  ...
  it('does not render trend indicator when trend is not provided', () => {
    const { container } = render(<StatCard label="Test Label" value="100" />);
