    ...
    <div className="flex-col-24 fade-in-entry">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
        <StatCard
          ...
          subtitle={journalStats.total > 0 ? getMoodLabel(journalStats.avgMood) : t('dashboard.noEntries')}
          icon={<Smile size={20} />}
          accent
        />
        <StatCard
        ...
        <div className="glass-panel padding-20-flex-col-12" style={{ border: '1px solid var(--border)' }}>
          ...
          <div className="flex-col-12" style={{ flex: 1, justifyContent: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-primary)' }}>{t('dashboard.daySchedule')}</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-primary)' }}>{t('dashboard.habitTracker')}</div>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
